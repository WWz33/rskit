...
from rnaseq_tools.config import PipelineConfig
from rnaseq_tools.core.star import StarIndexer, StarAligner
from rnaseq_tools.core.salmon import SalmonQuantifier
from rnaseq_tools.utils.logger import get_logger
from rnaseq_tools.utils.validators import check_star_index
...
class RNAseqPipeline:
    ...
    def run(self, samples: Dict[str, Dict], genome_fasta: str, gtf_file: str,
            transcript_fasta: str, index_dir: str, output_dir: str, force_index: bool = False) -> Dict:
        results = {}
        ...
        for sample_name, sample_data in samples.items():
            ...
            salmon_output = sample_output / "salmon"
